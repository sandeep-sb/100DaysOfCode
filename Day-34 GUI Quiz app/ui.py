...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.false_button = Button(image=false_button_img, command=self.false_button_click)
        self.false_button.grid(row=2, column=0)
        true_button_img = PhotoImage(file="./images/true.png")
        self.true_button = Button(image=true_button_img, command=self.true_button_click)
