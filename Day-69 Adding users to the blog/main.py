...
class BlogPost(db.Model):
    ...
    # The "parent_posts" refers to the parent_posts property in the Comment class.
    comments = db.relationship("Comment", back_populates="parent_posts")
...
class Comment(UserMixin, db.Model):
    ...
    parent_posts = db.relationship("BlogPost", back_populates="comments")
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        new_comment.parent_posts = requested_post
